...
public class Users {
    ...
    public Map<String, String> build(String firstName, String lastName, String email) {
        Map<String, String> user = build(email);
    ...
    public Map<String, String> build(String id, String firstName, String lastName, String email) {
        Map<String, String> user = build(firstName, lastName, email);
