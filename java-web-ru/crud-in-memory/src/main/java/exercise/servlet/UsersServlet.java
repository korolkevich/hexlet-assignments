...
public class UsersServlet extends HttpServlet {
    ...
    private void createUser(HttpServletRequest request,
        ...
        if (firstName.isEmpty() || lastName.isEmpty()) {
            ...
            request.setAttribute("user", Map.of("firstName", firstName, "lastName", lastName, "email", email));
            request.setAttribute("error", "firstName & lastName must not be empty");
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/new.jsp");
            requestDispatcher.forward(request, response);
        } else {
            users.add(Map.of("id", getNextId(), "firstName", firstName, "lastName", lastName, "email", email));
            request.setAttribute("users", users);
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/users.jsp");
            requestDispatcher.forward(request, response);
        }
    ...
    private void updateUser(HttpServletRequest request,
        ...
        if (firstName.isEmpty() || lastName.isEmpty()) {
            ...
            users.set(Integer.parseInt(user.get("id")), user);
            request.setAttribute("users", users);
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("/users.jsp");
            requestDispatcher.forward(request, response);
        }
