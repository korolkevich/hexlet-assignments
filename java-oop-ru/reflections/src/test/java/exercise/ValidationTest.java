...
//        Address address1 = new Address("Russia", "Ufa", "Lenina", "54", null);
//        List<String> result1 = Validator.advancedValidate(address1);
//        List<String> expected1 = List.of();
//        assertThat(result1).isEqualTo(expected1);
//
//        Address address2 = new Address(null, "London", "1-st street", "5", "1");
...
//        assertThat(result3).isEqualTo(expected3);
        ...
        Address address2 = new Address("USA", "A", "B", "7", "2");
        Map<String, List<String>> expected2 = new HashMap<>();
        expected2.put("country", List.of("length less than 4"));
        expected2.put("city", List.of("length less than 2"));
        expected2.put("street", List.of("length less than 2"));
